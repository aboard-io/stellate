...
import { S, K, set, deep } from "../core/state.js";
import { currentMeasure } from "../core/share.js";   // the ONE measure law (buildShareUrl reads it too)
...
// ---------- headless probe hooks (test/browser/midi-export.test.js) ----------
