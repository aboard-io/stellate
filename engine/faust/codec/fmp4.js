// faust/codec/fmp4.js — a hand-rolled audio-only FRAGMENTED-MP4 muxer (WAV-FIRST v4).
//
...
// (test/unit/fmp4.test.js). Given a codec + its config bytes it emits an ISO-BMFF init
...
(function (root, factory) {
  ...
  // caller — Opus has no ADTS analog. All exported so the node unit gate (test/unit/fmp4.test.js) can
