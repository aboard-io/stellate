// faust/codec/mp3-worker.js — the DEDICATED ENCODER worker (WAV-FIRST v3; v4 generalized).
//
...
async function initDeps() {
  const BASE = new URL(".", self.location.href).href;   // .../faust/codec/
  const FAUST = new URL("..", BASE).href;               // .../faust/
  await import(FAUST + "vendor/lamejs.min.js");          // -> self.lamejs
