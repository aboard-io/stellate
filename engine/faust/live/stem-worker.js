// faust/live/stem-worker.js — ZERO-STATIC Stage 3: the rolling stem pre-render.
//
...
// carries them. test/unit/stem-parity.test.js gates this against render-core
...
if (typeof WorkerGlobalScope !== "undefined" && typeof self !== "undefined" && self instanceof WorkerGlobalScope) {
  (function () {
    ...
    async function initDeps() {
      await import(FAUST + "../theory.js");         // -> globalThis.CsdTheory (MUSIC-MIND organ; must precede csd-engine)
      await import(FAUST + "../pipes.js");          // -> globalThis.CsdPipes  (MUSIC-MIND organ; must precede csd-engine)
      await import(FAUST + "../csd-engine.js");     // -> globalThis.CsdEngine
      await import(FAUST + "voices/state-engine.js");      // -> globalThis.FaustStateEngine
      await import(FAUST + "press/render-core.js");       // -> globalThis.FaustRenderCore (mergeIvals)
