...
const { launchChromium, MIME } = require("./probe-harness.js");
...
(async () => {
  ...
  await page.goto(`http://localhost:${PORT}/explorer.html?clicktest=1`, { waitUntil: "domcontentloaded" });
