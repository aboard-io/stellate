#!/usr/bin/env node
// faust/stem-parity-test.js — ZERO-STATIC Stage 3 CI parity gate (standalone;
// wired into nothing — engine.test.js's quick loop stays fast).
//
//   node faust/stem-parity-test.js
//
