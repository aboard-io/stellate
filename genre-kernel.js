...
(function (root) {
  ...
  const GENRES = {
    ...
    house: { label:"House", info:"four-on-floor + claps, warm 7ths, 8-bar additive builds",
      ...
      progressions:["house_min7","lofi","deep_two"], kits:["house","four"], fills:["off","hat rush","riser"],
      bass:{patterns:["rolling","melodic","stab"], recipe:{model:["saw","sub"],cutoff:[380,700],res:[.15,.3],level:[1.0,1.2],send:[0,.08],dsend:[0,.05]}},
    ...
    triphop: { label:"Trip hop", info:"slowed dusty breaks, jazz color, melancholy, dub weight",
      ...
      stab:["off"], hits:{sources:["vox_b","blues_vox_78","sp_slowdown"], pattern:"sparse", prob:.45},
      form:"pop" },
    ...
    edm: { label:"EDM", info:"festival big-room: riser into THE DROP, max pump, supersaw walls",
      ...
      lead:{patterns:["hero","updown","double"], recipe:{model:["stack","brass"],wave:"saw",voices:[6,8],spread:[.012,.02],cutoff:[3000,4200],level:[.5,.65],send:[.35,.55],dsend:[.2,.35]}},
