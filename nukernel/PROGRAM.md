...
`--bar-h: 52px` (still declared; nothing on the page is that tall any more — see the `.nu-bar` reversal in §2.4.1) · `--head-h: 38px` · `--wash: 4%` (the section colour, §2.4.2). The 36px cell clears WCAG 2.2 AA Target Size
