// PORTED VERBATIM, 2026-09-02, from `f0f9d89:app/starcruise/traits.js`.
// Paul, 2026-09-01: *"Why not three js? It's fine. Don't reinvent."* Nothing
// below this block is changed — including `traitsFromGenre`'s K/V arguments,
// which nukernel has no globals for. ./from-doc.js builds a K/V pair out of
// the document and the genre row and hands it in through this same door, so
// the 729 lines of tuned mapping that ARE the creative heart stay one copy.
