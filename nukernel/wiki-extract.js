...
const ASK = {
  ...
  mawsili:    { q: "Ishaq al-Mawsili", why: "Baghdad 800; the row is the Abbasid court school and Ishaq is its codifier and Ziryab's own teacher — the Kitab al-Aghani, which documents the repertory, is a book about songs rather than the songs; the man is the nearer subject.", kind: "artist" },
