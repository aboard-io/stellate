...
const ASK = {
  ...
  cologneschool: { q: "Studio for Electronic Music (WDR)", why: "the studio down the Rhine — the place-school key parallels berlinschool and the studio's article is the school's own subject; renamed 2026-09-01 off the composer three anchors once wanted by name." },
  ...
  amenbreak:   { q: "Amen break", why: "Washington 1969 is Amen, Brother; the article is the seven seconds the two paying rows (dnb, hardcorerave) actually wanted, with the band, the B-side and Coleman's four bars as its own subject. The Winstons' band article is the runner-up; the debt was the break.", kind: "work" },
  ...
  bristolsound: { q: "Bristol sound", why: "the scene term with its own article, and the Mezzanine row is its central case (Blue Lines keeps triphop; a record pays one debt); renamed 2026-09-01 off the band." },
  ...
  spaceopera: { q: "Star Wars (soundtrack)", why: "Los Angeles 1979 anchors the neo-romantic revival whose year zero is this record — March 1977, a symphony orchestra reading to picture when the idiom was believed dead — and the album article is the honest subject: the spyscore/polychoral one-work precedent, chosen over John Williams because the row is the revival and not the career, and over Film score, the craft survey goldenagescore's own row already refused.", kind: "work" },
  epichybrid: { q: "Hans Zimmer", why: "Santa Monica 2010 is the braam's own year, and no genre article for the epic hybrid score exists in this ZIM (`Epic music` 404s; Film score is the refused craft survey) — so the row links the composer whose Santa Monica complex the idiom was literally built in, the goldenagescore/suspensescore artist precedent. The KEY stays a genre term per the round's naming law; the link names the man because the encyclopedia gave no other musical subject.", kind: "artist" },
  ...
  crimejazz:  { q: "Elmer Bernstein", why: "Los Angeles 1955 is the year the big band walked into the pictures — the narcotics-picture main title a jazz orchestra played as itself — and `Crime jazz` was probed and is not in this ZIM (404), so the row links the composer of that 1955 score, the horrorscore precedent exactly: the man's article IS about the scores. Not Henry Mancini, whose television detective jazz is 1958, three years downstream of this label.", kind: "artist" },
  fantasyscore: { q: "Music of The Lord of the Rings film series", why: "Wellington 2001, and the article is the commission itself — the biggest orchestral score of its decade, written about at book length under its own title — which makes it the rare case where the WORK article is also the school's founding document. Not Howard Shore, the man where this row is the idiom; not Fantasy film, a picture article and the muzak wall.", kind: "work" },
  nordicscore: { q: "Jóhann Jóhannsson", why: "Reykjavík 2015 is the string-cluster school's arrival on the prestige screen, and no genre article for it exists in this ZIM — the row links the Reykjavík composer whose article is the school's own obituary-shaped summary (drones, tape, a chamber section processed until the room is the instrument), the artist precedent again.", kind: "artist" },
  dramascore: { q: "Thomas Newman", why: "Los Angeles 1999 is the suburban-interiors underscore — mallets, felt piano, air — and the school has no genre article in this ZIM, so the row links the composer whose 1999 lawn-and-dusk score every mallet cue since has quoted; his article opens on exactly the scoring career the anchor describes.", kind: "artist" },
  frontierscore: { q: "Jerome Moross", why: "Los Angeles 1958 is the year the big-sky main-title grammar was set, and the composer who set it is the honest subject this ZIM holds (`Western music` disambiguates to a hemisphere, the western film article is a picture, not a music) — the horrorscore precedent: the man's article is about the scores, and its own lead names the 1958 main title the label dates.", kind: "artist" },
...
const NOLINK = {
  ...
  synthsoul: "London 1983 — the great rename (2026-09-01, Paul: \"ONLY genre\") took the act's article with the act's key: the row is a soul voice over a Model D two-chord vamp, synthpop and blueeyedsoul are taken, so the key is the flagged coinage synthsoul — and a coinage has no article by design. A wrong link is worse than none.",
  detroitsoul:     "Detroit 1965 — the great rename (2026-09-01): `Motown` is a company's article (the label first, the Sound second) and this row stopped claiming the trademark; Detroit soul has no article of its own in this ZIM. A wrong link is worse than none.",
  industrialdance:    "Chicago 1981 — the great rename (2026-09-01): the label article this row used to link is a company's page, which is exactly the claim Paul ruled out, and industrial dance has no article of its own in this ZIM (`ebm` is a separate, later-dated anchor). The dating work the old why did — shop Denver 1974/Chicago 1978, label 1980, row 1981 — lives in the row's comment. A wrong link is worse than none.",
  beiruttarab:     "Beirut 1957 — the great rename (2026-09-01): the style's usual name (Rahbani) is also a person, so the key is the flagged place+genre coinage beiruttarab, and no article exists for it; the singer's article went with her name. The tarab parent (Cairo 1934) still carries the declared edge, named by the subject itself. A wrong link is worse than none.",
  abbasid:    "Baghdad 800 — the great rename (2026-09-01): the row is the Abbasid court practice, the maqam fountainhead, and this ZIM has no article for the practice itself; the theorist's article went with his name (the 2026-08-30 Ibrahim/Ishaq correction, and the Ibrahim question, stay recorded in the row's history). A wrong link is worse than none.",
  technopop:        "Tokyo 1978 — the great rename (2026-09-01): technopop is the established Japanese word for precisely this sound and enwiki holds only a redirect, not an article; the band's article went with the band's initials. A wrong link is worse than none — the reported miss is correct.",
  leedsgoth:    "York 1981 — the great rename (2026-09-01): the key is the flagged place-scene coinage leedsgoth on the madchester pattern (gothicrock is the Northampton anchor's word), and no article files the Leeds machine-goth scene under that name; the band's article went with the band's name. A wrong link is worse than none.",
  tsabatsaba:   "Bulawayo 1947 — the great rename (2026-09-01): tsaba-tsaba is the genre the record was cut in — the old row's own comment conceded it and anchored the song only because the ZIM lacks a tsaba-tsaba article; under the honest word the song-title link drops. A wrong link is worse than none — the reported miss is correct.",
  viennadownbeat: "Vienna 1993 — the great rename (2026-09-01): the Vienna scene's own name for itself is downbeat, a place+scene key on the madchester pattern, and no article files it; the duo's article went with the surnames. A wrong link is worse than none.",
  noirhop: "Bristol 1994 — the great rename (2026-09-01): triphop is Blue Lines' word, so the key is the flagged coinage noirhop — a TORCH SONG on a turntable — and a coinage has no article by design; the band's article went with the band's name. A wrong link is worse than none.",
  knowlewest:     "Bristol 1995 — the great rename (2026-09-01): the key is the place the record is (the row's own comment: 'Knowle West, the record is that upbringing', the hohlefels rule), and the estate has no music article; the man's article went with his stage name. A wrong link is worse than none.",
  torchbreaks:       "Manchester 1996 — the great rename (2026-09-01): half-time torch song over double-time dnb breaks has no established name, so the key is the flagged coinage torchbreaks, which has no article by design; the duo's article went with the animal-word band name. A wrong link is worse than none.",
  versailles:        "Versailles 1998 — the great rename (2026-09-01): the press called this wave 'the Versailles sound' and the key is now the town, the hohlefels rule; the town's article is not a music subject and the duo's article went with the band name. A wrong link is worse than none.",
  tromso:   "Tromsø 2001 — the great rename (2026-09-01): dance writing knows 'the Tromsø scene' and the key is the town on the neworleans/winchester pattern; the town's article is not a music subject and the duo's article went with the band name. A wrong link is worse than none.",
  goldenagescore:   "Los Angeles 1938 — the great rename (2026-09-01): Golden Age scoring has no genre article in this ZIM (Film score is the craft survey this table already refused) and the composer's article went with the composer key. A wrong link is worse than none.",
  suspensescore:   "Los Angeles 1960 — the great rename (2026-09-01): no genre article exists for the ostinato-and-stab suspense score; the composer's article went with the composer key. A wrong link is worse than none.",
  spaghettiwestern:  "Rome 1966 — the great rename (2026-09-01): the key is the genre word, but `Spaghetti Western` is a film article this table's own music test refuses (the previous why said so in as many words), and the composer's article went with the composer key. A wrong link is worse than none.",
  spyscore:      "London 1962 — the great rename (2026-09-01): the commission is the genre and the franchise theme is a BRAND — linking the James Bond Theme claims exactly the association Paul ruled out, and spy scoring has no genre article in this ZIM. A wrong link is worse than none.",
  horrorsynth:  "Los Angeles 1978 — the great rename (2026-09-01): horrorsynth is the community's word for minimalist sequenced horror scoring and has no article in this ZIM; the director-composer's article went with his name. A wrong link is worse than none.",
  copshowsynth:  "Miami 1984 — the great rename (2026-09-01): the key is the flagged descriptive coinage copshowsynth (synthwave is its later child, in-table) and no genre article exists; the show is a crime drama's article and the session hands' articles went with their names. A wrong link is worse than none.",
  horrorscore: "Bray 1958 — the great rename (2026-09-01): 'Hammer horror' is a studio's brand (the muzak wall already ruled on the company page) and orchestral gothic horror scoring has no genre article in this ZIM; the composer's article went with the person-key era. A wrong link is worse than none.",
