...
const GATES = [
  ...
  { name: "als-page",   wave: 3, kind: "browser", url: { flag: "--page" },
    ...
    covers: ["test/als-page.browser.js", "nukernel/export/als-page.js",
             ...
             // ...and the four other photographs of a donor the page carries,
             // every one of which this gate now `--check`s (2026-09-03, P3, the
             // Answers round which added the master chain, and the Answers2
             // round which added the phaser and the amp). This row is also the
             // ONE registered gate that exports a MASTERED record: the shipped
             // chant carries master words, so gate B's present-is-real branch
             // runs here on every wave-3 pass while the `ableton` row below runs
             // its absent-is-today branch.
  ...
  /* THE BANK'S PICTURES (2026-09-14): a line motif's engraving, a drum motif's
     pattern, and a tap on either opens the motif — onto the bench above. */
  { name: "motif-bank", wave: 2, kind: "browser", url: { env: "MOTIF_URL" },
    argv: ["test/motifbank.browser.js"], need: ["test/motifbank.browser.js"],
    covers: ["test/motifbank.browser.js", "nukernel/ui/motifthumb.js"] },
