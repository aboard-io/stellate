#!/usr/bin/env node
// test/browser/bg-survival.test.js — headless probe for the background-survival state machine
...
//      (test/browser/bg-handoff.test.js covers it under an iPhone UA).
...
//
//   node test/browser/bg-survival.test.js
//
