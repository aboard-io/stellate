#!/usr/bin/env node
// test/browser/crossfade-seam.test.js — THE CROSSFADE SEAM GATE.
//
//   NODE_PATH=/home/ford/ftrain-2025/node_modules node test/browser/crossfade-seam.test.js
//
// The gate hole that let docs/TIMING-AUDIT-2026-07 finding 2 live for months:
// test/browser/live.test.js does ONE swap and asserts RMS non-zero + loadRatio >= 0.97.
...
//
// Runs against test/browser/live-test.html on the desktop ring path (?wavOut=0).
"use strict";
