#!/usr/bin/env node
// test/browser/explorer-ui.test.js — headless UI gate for three explorer product laws:
...
//   node test/browser/explorer-ui.test.js
"use strict";
...
async function main() {
  ...
  const lab = await page.evaluate(() => {
    ...
    // labels are drawn in the session's ALIEN ALPHABET (app/map/glyphs.js alienize:
