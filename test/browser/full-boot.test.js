#!/usr/bin/env node
// test/browser/full-boot.test.js — the REAL FULL-APP BOOT smoke gate (browser battery).
//
...
// missing from app/core/world.js POS sending computeGenreLayout into its relaxation and
...
//     loader hook window.__ensureStarcruise is published by app/panels/panels.js, and
...
//
//   node test/browser/full-boot.test.js
//
...
(async () => {
  ...
  const r = await page.evaluate(() => ({
    ...
    // loader hook must be present (app/panels/panels.js publishes it at module eval).
