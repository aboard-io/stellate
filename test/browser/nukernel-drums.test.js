...
//   ((H) WAS THE SINGER — a sung note rendered offline and its F0 measured
//       against the note it was planned onto, plus the duet interval, the
//       vocoder and the per-note node cost. nukernel's espeak singer came out
//       on 2026-08-17; nukernel/kernel-daw.html carries the tombstone.)
//
...
// ((H)'s singProbe stood here: one sung note, alone, through the page's own
// buildChannel and playSyllable into an OfflineAudioContext, with the found
// layer's F0 detector run over the rendered PCM. The singer came out on
// 2026-08-17 and took its probe with it.)
