#!/usr/bin/env node
// test/browser/wavout.test.js — headless WAV-FIRST gate (gate 3, updated for v3).
//
//   node test/browser/wavout.test.js
//
// TWO passes in chromium (the pinned build), both booting test/browser/live-test.html with
