...
//   node tools/feature-layout3d.js && node tools/cluster-genres.js
...
if (missingCoords.length || missingCluster.length) {
  ...
  console.error(`      node tools/feature-layout3d.js && node tools/cluster-genres.js`);
  process.exit(1);
}
