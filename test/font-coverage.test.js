...
// (tools/font-coverage.js): the STRUCTURAL audit must hold — every SAMPLERS id
...
//   node test/font-coverage.test.js
"use strict";
const { execFileSync } = require("child_process");
const path = require("path");
try {
  const out = execFileSync("node", [path.join(__dirname, "..", "tools", "font-coverage.js")], { stdio: ["ignore", "pipe", "pipe"], timeout: 300000 }).toString();
