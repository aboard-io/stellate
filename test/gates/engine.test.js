...
function press(name, state) {
  ...
  return new Promise((resolve) => {
    execFile("node", [path.join(HERE, "..", "..", "engine", "faust", "press", "press.js"), sj, wav, "--dur", String(DUR)],
...
(async () => {
  ...
  {
    const RC = require("../../engine/faust/press/render-core.js");
    const src = fs.readFileSync(path.join(HERE, "..", "..", "engine", "faust", "press", "press.js"), "utf8");
  ...
  presses.push((async () => {
    ...
    try {
      const PRESS = require("../../engine/faust/press/press.js");
