...
//
//   node test/kernel-data-identity.test.js
//
...
try {
  ...
  try {
    fs.writeFileSync(path.join(headDir, "engine", "faust", "dx7-presets.json"),
      execFileSync("git", ["show", "HEAD:engine/faust/dx7-presets.json"], { cwd: ROOT, maxBuffer: 64 * 1024 * 1024, stdio: ["ignore", "pipe", "ignore"] }));
  } catch (e) { /* optional */ }
