...
// verification probes (test/browser/live.test.js + probe-*.js). One static file server +
...
const MIME = { ".html": "text/html", ".js": "text/javascript", ".mjs": "text/javascript",
  ...
  // A module served application/octet-stream fails strict
  ...
  // ".css" for the app/ CSS split: index.html loads app/app.css
...
// app/core/state.js imports preact+htm from https://esm.sh as ES modules. In this
...
async function installOfflineRoute(page, port, opts) {
  ...
  await page.route("**/*", (route) => {
    ...
    if (u.startsWith(`http://localhost:${port}`)) {
      ...
      // app/map/starmap.js computeGenreLayout() synchronously at module-eval; under
...
// Gates that neutralise app/main.js never evaluate app/panels/panels.js, so the loader
