#!/usr/bin/env node
// test/live-walk-parity.test.js — THE SEAM GATE (docs/TIMING-AUDIT-2026-07 finding 1).
//
//   node test/live-walk-parity.test.js [--bars 24] [--all] [--verbose]
//
// The hole this closes, in the audit's own words: "test/segment-parity-test.js
...
require(path.join(ROOT, "engine", "faust", "live.js"));
