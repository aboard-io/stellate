#!/usr/bin/env node
// test/probes/mbcomp.probe.js — fx wings STAGE 4 gate: the 3-band MASTER glue-comp
...
//
//   node test/probes/mbcomp.probe.js
"use strict";
const fs = require("fs");
...
(async () => {
  ...
  const press = (a, b) => execFileSync(process.execPath, [path.join(__dirname, "..", "..", "engine", "faust", "press", "press.js"), a, b, "--dur", "30"], { stdio: "pipe" }).toString();
