#!/usr/bin/env node
// test/probes/wah.probe.js — fx wings STAGE 3 gate: the crybaby/Mutron AUTO-WAH insert.
//
...
(async () => {
  ...
  if (st) {
    ...
    const press = (a, b) => execFileSync(process.execPath, [path.join(__dirname, "..", "..", "engine", "faust", "press", "press.js"), a, b, "--dur", "45"], { stdio: "pipe" }).toString();
