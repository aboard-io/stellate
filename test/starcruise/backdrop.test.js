#!/usr/bin/env node
// test/starcruise/backdrop.test.js — headless proof for app/starcruise/backdrop.js (the procedural
...
//
//   node test/starcruise/backdrop.test.js
"use strict";
const path = require("path");
const { serve, capturePageErrors, installOfflineRoute } = require("../lib/probe-harness.js");
