#!/usr/bin/env node
// test/starcruise/postfx.test.js — headless proof for app/starcruise/postfx.js (the PS1 look).
...
//
//   node test/starcruise/postfx.test.js
"use strict";
const path = require("path");
const { serve } = require("../lib/probe-harness.js");
