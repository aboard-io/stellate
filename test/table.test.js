...
const T4O_PIN = {
  ...
  /* HYMN'S ALTO SANG TENOR AND ITS TENOR SANG BASS until 2026-09-07, when
     the description audit read the row back to itself: its own `words` say
     SATB and its throats said S-T-B. The chairs are the row's own now. */
  "hymn/1":            "voice:soprano:1 voice2:alto:0 voice3:tenor:0 vocal:alto:0",
  "hymn/2":            "voice:soprano:1 voice2:alto:0 voice3:tenor:0 vocal:alto:0 gregorian:tenor:0",
  "hymn/3":            "voice:soprano:1 voice2:alto:0 voice3:tenor:0 vocal:alto:0",
