// test/unit/all-sampled.test.js — SAMPLED-DEFAULT gate: the sampled render path.
//   node test/unit/all-sampled.test.js
//
...
function press(name, state) {
  ...
  execFileSync("node", [path.join(HERE, "..", "..", "engine", "faust", "press", "press.js"), sj, wav, "--dur", "8"], { stdio: ["ignore", "ignore", "inherit"], maxBuffer: 16 * 1024 * 1024 });
