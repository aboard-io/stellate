#!/usr/bin/env node
// test/unit/feature-pca.test.js — unit test for tools/genre/feature-pca.js + engine/checks/dead-axis.js
// Fast, narrow, deterministic. Run: node test/unit/feature-pca.test.js
"use strict";
const assert = require("assert");
const path = require("path");
const ROOT = path.join(__dirname, "..", "..");
const DA = require(path.join(ROOT, "engine", "checks", "dead-axis.js"));
const PCA = require(path.join(ROOT, "tools", "genre", "feature-pca.js"));
