#!/usr/bin/env node
// test/unit/fmp4.test.js — the WAV-FIRST v4 muxer unit gate (WAV-FIRST.md v4 gate a).
//
//   node test/unit/fmp4.test.js
//
...
const { makeFmp4Mux, stripAdts, synthAsc, extractAsc: extractAscCfg, srIndexFor, parseAdtsHeader } = require(path.join(__dirname, "..", "..", "engine", "faust", "codec", "fmp4.js"));
