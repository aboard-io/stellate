#!/usr/bin/env node
// test/unit/segment-parity.test.js — the Phase 1-2 gate for faust/stream-renderer.js.
//
//   NODE_PATH=faust/node_modules node test/unit/segment-parity.test.js [--dur N] [--full]
//
...
//
// GATE (mirrors test/unit/stem-parity.test.js): per channel, RMS correlation > 0.999
...
const SR_JS = require(path.join(__dirname, "..", "..", "engine", "faust", "live", "stream-renderer.js"));
...
// ---- comparison helpers (test/unit/stem-parity.test.js) ----
