#!/usr/bin/env node
// test/unit/snare-law.test.js — the SNARE-LAW regression gate. Renders every genre × seeds
...
//
//   node test/unit/snare-law.test.js            all 63 genres × seeds 1..5  (the gate)
//   node test/unit/snare-law.test.js --quick    a 6-genre spread × seeds 1..3
//   node test/unit/snare-law.test.js --stats    also print per-genre fire-rate estimates
//
