#!/usr/bin/env node
// test/unit/vocoder.test.js — listen-test for robot_choir.dsp (ve.vocoder channel
...
// Writes vocoder-render.wav for ears. Usage: node test/unit/vocoder.test.js [speech.wav]
"use strict";
const fs = require("fs");
