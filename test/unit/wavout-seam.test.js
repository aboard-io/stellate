#!/usr/bin/env node
// test/unit/wavout-seam.test.js — the WAV-FIRST producer gates 1/2/4 (WAV-FIRST.md), in
...
//
//   node test/unit/wavout-seam.test.js
//
...
const GK = require(path.join(__dirname, "..", "..", "engine", "genre-kernel.js"));
const E = require(path.join(__dirname, "..", "..", "engine", "csd-engine.js"));
const SE = require(path.join(__dirname, "..", "..", "engine", "faust", "voices", "state-engine.js"));
const FP = require(path.join(__dirname, "..", "..", "engine", "faust", "voices", "found-player.js"));
const SP = require(path.join(__dirname, "..", "..", "engine", "faust", "voices", "sampler.js"));
const RCORE = require(path.join(__dirname, "..", "..", "engine", "faust", "press", "render-core.js"));
const press = require(path.join(__dirname, "..", "..", "engine", "faust", "press", "press.js"));
const { makeStreamEngine } = require(path.join(__dirname, "..", "..", "engine", "faust", "live", "stream-renderer.js"));
const lamejs = require(path.join(__dirname, "..", "..", "engine", "faust", "vendor", "lamejs.min.js"));
const { makeMp3Stream } = require(path.join(__dirname, "..", "..", "engine", "faust", "codec", "mp3-stream.js"));
