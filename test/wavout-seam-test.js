...
const RCORE = require(path.join(__dirname, "..", "engine", "faust", "render-core.js"));
const press = require(path.join(__dirname, "..", "engine", "faust", "press.js"));
const { makeStreamEngine } = require(path.join(__dirname, "..", "engine", "faust", "stream-renderer.js"));
const lamejs = require(path.join(__dirname, "..", "engine", "faust", "vendor", "lamejs.min.js"));
const { makeMp3Stream } = require(path.join(__dirname, "..", "engine", "faust", "mp3-stream.js"));
