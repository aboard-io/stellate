#!/usr/bin/env node
// relayout-map.js — re-bake app/core/world.js POS so every genre's NAME has room.
//
//   node tools/build/relayout-map.js [--write] [--capacity 400] [--report]
//
...
const WORLD = path.join(ROOT, "app", "core", "world.js");
...
// Solved at the GATE's viewport (test/browser/explorer-ui.test.js uses 1200x850), not a
...
if (!block) { console.error("could not find the POS block in app/core/world.js"); process.exit(1); }
const POS = {};
...
if (!has("write")) { console.log("\n(dry run — pass --write to re-bake app/core/world.js POS)"); process.exit(0); }
...
const header = `// BAKED STAR POSITIONS — generated by tools/build/relayout-map.js.
//
...
//
// Re-bake with:  node tools/build/relayout-map.js --write --capacity ${CAPACITY}
...
console.log(`\n✓ re-baked ${names.length} positions into app/core/world.js`);
