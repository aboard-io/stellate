...
//
//   node tools/build/transcode-beds.js [--dry] [--keep-old] [--jobs N]
"use strict";
const fs = require("fs");
...
(async () => {
  ...
  console.log(`  resolver convention must be found/<id>${SUFFIX} — see engine/faust/voices/found-player.js localPathFor`);
