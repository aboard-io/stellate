...
//
//   node tools/ci-standin-media.js          # writes only what's missing
//   node tools/ci-standin-media.js --list   # print the enumerated paths, write nothing
//
// The one rule: source is committed, audio is derived and gitignored. That
// means a fresh clone has recipes but no media — and test/engine.test.js
