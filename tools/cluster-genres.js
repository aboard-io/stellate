#!/usr/bin/env node
// tools/cluster-genres.js — the STAR-SYSTEM clustering for star-cruise 3D mode.
//
...
//
// CLI:
//   node tools/cluster-genres.js [--max <n>] [--out <path>]
...
function serialize(built) {
  ...
  const lines = [];
  lines.push("// app/starcruise/genre-clusters.js — AUTO-GENERATED by tools/cluster-genres.js.");
  lines.push("// Do not edit by hand: re-run `node tools/cluster-genres.js` to regenerate.");
  lines.push("//");
