#!/usr/bin/env node
// tools/cross-metric-audit.js — CROSS-METRIC RECONCILIATION AUDIT (ROADMAP §1.4.6).
//
...
//   (3) FEATURE-LAYOUT 2D     — tools/feature-layout.js buildLayout(): the PCA
...
//
// CLI:
//   node tools/cross-metric-audit.js [--top N] [--focus <genre>] [--json]
