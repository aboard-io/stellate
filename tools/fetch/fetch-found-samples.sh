...
# SF2 (no preset/zone/loop model in `soundfile`), so engine/faust/build/sf2.js extracts the
...
if [ ! -s found/samples/instruments/alto_sax/zones.json ]; then
  ...
  for p in "Alto Sax" "Tenor Sax" "Nylon String Guitar" "Steel String Guitar" \
    ...
    node engine/faust/build/sf2.js extract /tmp/FluidR3_GM_GS.sf2 "/$p/" found/samples/instruments --max-zones 6
  done
...
if [ ! -s found/samples/instruments/rhodes_ep/zones.json ]; then
  ...
  [ -s /tmp/FluidR3_GM_GS.sf2 ] || curl -sL --max-time 900 -o /tmp/FluidR3_GM_GS.sf2 \
    "$IA/fluidr3-gm-gs/FluidR3_GM_GS.sf2"
  node engine/faust/build/extract-gm.js /tmp/FluidR3_GM_GS.sf2 found/samples/instruments --max-zones 6
  rm -f /tmp/FluidR3_GM_GS.sf2
fi
...
if [ ! -s found/samples/instruments/felt_piano/zones.json ]; then
  ...
  [ -s /tmp/FluidR3_GM_GS.sf2 ] || curl -sL --max-time 900 -o /tmp/FluidR3_GM_GS.sf2 \
    "$IA/fluidr3-gm-gs/FluidR3_GM_GS.sf2"
  node engine/faust/build/sf2.js extract /tmp/FluidR3_GM_GS.sf2 "/Yamaha Grand Piano/" found/samples/instruments --max-zones 10
...
# (boom/808/909 …): engine/faust/build/sf2.js `drumkit` pulls the notes the engine plays
...
if [ ! -s found/samples/drums/acoustic/kit.json ]; then
  ...
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Standard/"   found/samples/drums --slug acoustic
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Room/"       found/samples/drums --slug room
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Power/"      found/samples/drums --slug power
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Electronic/" found/samples/drums --slug electronic
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Jazz/"       found/samples/drums --slug jazz
  node engine/faust/build/sf2.js drumkit /tmp/FluidR3_GM_GS.sf2 "/Brush/"      found/samples/drums --slug brush
  rm -f /tmp/FluidR3_GM_GS.sf2
fi
...
if [ ! -s found/samples/perc/standard/perc.json ]; then
  ...
  node engine/faust/build/sf2.js percbank /tmp/FluidR3_GM_GS.sf2 "/Standard/" found/samples/perc --slug standard
  rm -f /tmp/FluidR3_GM_GS.sf2
fi
...
#   done
#   node engine/faust/build/sysex2params.js /tmp/rom1a.syx "/E.PIANO 1/" "/BRASS   1/" ...
#   node engine/faust/build/build.js dx7_algN   # per algorithm the kept patches need
...
node tools/build/transcode-samples.js
