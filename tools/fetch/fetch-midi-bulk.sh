...
# Companion to tools/fetch/fetch-midi-trove.sh (the labeled rips). See SOURCES.md.
#
#   tools/fetch/fetch-midi-bulk.sh [dest]     # default /mnt/sources/relocated/stellate-midi-corpus/bulk
#
# Feeds tools/mine/corpus-db.js build + tools/mine/mine-theory.js (harmony transition
