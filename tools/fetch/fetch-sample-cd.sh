...
# tools/fetch/classify-sample-cd.py) → rename meaningfully from the detected metadata
...
echo "→ classifying"
python3 tools/fetch/classify-sample-cd.py "$trimmed" --json "$work/classified.json" >/dev/null
