...
//
//   node tools/gen-font.js <font.sf2> <key> "<Label>"
"use strict";
const fs = require("fs");
const path = require("path");
const SF2 = require("../engine/faust/sf2.js");
...
fs.writeFileSync(path.join(ROOT, "engine/faust/font-" + key + ".json"), JSON.stringify(out));
// register in the manifest the app reads (idempotent: replace/append this key)
try {
  const mf = path.join(ROOT, "engine/faust/fonts.json");
