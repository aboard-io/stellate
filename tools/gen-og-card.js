#!/usr/bin/env node
// tools/gen-og-card.js — render STELLATE's social card + favicons from a recipe.
//
// WHY THIS EXISTS
// ---------------
...
// (test/probe-harness.js). Nobody hand-tunes a PNG in a paint program; you edit
...
//
// USAGE
//   node tools/gen-og-card.js           # everything
//   node tools/gen-og-card.js --card    # just assets/og-card.png (1200x630)
//   node tools/gen-og-card.js --icons   # just icon-32 / icon-180 / favicon.ico
//
// OUTPUTS
...
const { launchChromium } = require("../test/probe-harness.js");
