...
// tools/target-blend.js `solve` to get the NEAREST-REACHABLE weight vector. Report
...
//
// API:  const { evaluate, parse, buildTarget } = require('./tools/genre-math.js');
//       evaluate("jazz - swing + swing", { seed:1 })
//
// CLI:  node tools/genre-math.js "jazz - swing + fouronfloor" [--seed N] [--k 12]
//       node tools/genre-math.js "house + techno - wash" --seed 2 [--axis-sd 1]
//       node tools/genre-math.js --list-axes         (print the 23 feature axes + aliases)
