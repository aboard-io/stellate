...
//
// API:  const ES = require('./tools/genre/empty-space.js');
//       ES.envelope({ seed:1, n:300 })
//       ES.regions({ seed:1, n:300, bins:6, top:6 })
//       ES.classify({ bpm:200, wash:0.9 }, { seed:1, n:300 })
//
// CLI:  node tools/genre/empty-space.js envelope [--n N] [--seed S] [--json]
//       node tools/genre/empty-space.js regions  [--n N] [--seed S] [--bins B]
//                                           [--pairs a:b,c:d] [--top K] [--json]
//       node tools/genre/empty-space.js classify bpm=200,wash=0.9 [--n N] [--seed S] [--json]
