#!/usr/bin/env node
'use strict';
// tools/genre/leak-attribution.js  (ROADMAP §1.2.6 — Confusion-leak attribution)
//
...
//
// CLI:  node tools/genre/leak-attribution.js <A> <B> [--seeds=1,2,3,4,5] [--json] [--top=N]
...
function main(argv) {
  ...
  if (pos.length < 2) {
    console.error('usage: node tools/genre/leak-attribution.js <A> <B> [--seeds=1,2,3,4,5] [--json] [--top=N]');
    process.exit(2);
  }
