#!/usr/bin/env node
// tools/genre/rm-genre.js — remove a genre-tool-authored genre by stripping its marked
// blocks from genres-data.js (anchor+clips) and genre-verifier.js (target row).
// Does NOT touch app/core/world.js POS or the coords/clusters — re-bake those after.
//   node tools/genre/rm-genre.js <name> [<name>...]
"use strict";
const fs = require("fs");
