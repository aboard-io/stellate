...
// weights.
//
// API:  const { solve } = require('./tools/genre/target-blend.js');
//       solve({ scores:{jungle:0.8, gospel:0.2} }, { seed:1 })
//       solve({ features:{ bpm:140, sub:0.9, wash:0.1 } }, { seed:1 })
//
// CLI:  node tools/genre/target-blend.js scores jungle=0.8,gospel=0.2 [--seed N] [--k 8]
//       node tools/genre/target-blend.js features bpm=140,sub=0.9 [--seed N]
//       node tools/genre/target-blend.js anchor jungle [--seed N]   (round-trip self-test)
