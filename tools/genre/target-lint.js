...
//
//   node tools/genre/target-lint.js               lint all genres, print summary
//   node tools/genre/target-lint.js <genre>       full per-fence report for one genre
//   node tools/genre/target-lint.js <genre> --json    machine-readable one genre
//   node tools/genre/target-lint.js --json        machine-readable all genres
...
function main() {
  ...
  console.log("");
  console.log("run  node tools/genre/target-lint.js <genre>  for per-fence detail + suggestions");
}
