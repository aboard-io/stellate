#!/usr/bin/env bash
# tools/render-diff.sh — one-command byte-diff of symbolic renders.
#
...
#
# Usage:
#   tools/render-diff.sh <genre> [seed]           # e.g. vaporwave 1
#   tools/render-diff.sh --state <state.json>     # render a saved state
#   tools/render-diff.sh <genre> [seed] --ref <gitref>   # compare vs a ref
#
# Options:
